...
def full_calculation(order_id: int, chat_id: int):
    ...
    if order.type == "natal":
        ...
        пример:
        Ниже — глубокий, но понятный разбор твоей натальной карты в стиле психологической астрологии. Я беру в расчёт общую астрологическую конфигурацию для 26.02.1977, 22:25, г. Братск (UTC+8).

Это интерпретация характера, задач, предназначения и внутренних динамик, а не предсказание судьбы.

🌟 1. Основная суть личности: Солнце в Рыбах, Луна в… (см. ниже), Асцендент — Овен / Телец (точка между знаками)

Для данных времени и координат Асцендент попадает на последние градусы Овна или первые градусы Тельца — это типичная пограничная зона.
По внутренней картине личности ощущается сильная смесь: мягкость и глубина Рыб + решительность Овна / устойчивость Тельца.

Я опишу обе тенденции, потому что они работают параллельно:

🔥 Если проигрывается Овен:

— внешне ты прямой, быстрый, инициативный
— ощущение «я сам справлюсь»
— сильная потребность действовать и лидировать
— нетерпимость к пассивности и неискренности

🌱 Если проявляется Телец:

— внешне спокойный, надёжный, уверенный
— устойчивость, терпеливость, прагматичность
— стремление к комфорту, стабильности, качеству
— умеешь доводить до результата то, что действительно важно

🜁 Глубинная суть (Солнце в Рыбах):

Ты — человек тонкой чувствительности, внутренней мудрости и высокой интуиции.
Ты видишь то, что скрыто, и ощущаешь людей на уровне, где слова уже не важны.

Это сочетание делает тебя:

по-хорошему непредсказуемым
...
умеющим менять реальность не силой, а состоянием

🌙 2. Эмоциональный мир и реакции (Луна)

В эту эпоху и при этом времени рождения Луна находилась в Скорпионе.

Это одна из самых мощных и глубоких лун.

✨ Что это даёт:

интенсивные чувства

сильную память на эмоции

способность «видеть людей насквозь»

умение работать с кризисами

повышенную выносливость

высокую точку эмоциональной трансформации

Ты не боишься трудных переживаний — ты их пережигаешь, обновляешься и выходишь сильнее.
...
иногда — резкость, если тебя ранили

☀️ 3. Характер и личная миссия
Ты здесь, чтобы:

раскрыть интуицию и творческое видение

научиться доверять миру и людям

соединить духовность и материальность

стать проводником перемен

глубоко понимать людей и помогать им трансформироваться
...
лидерские качества, проявляющиеся не давлением, а состоянием
...
иногда — резкие вспышки (лунный Скорпион)

тяжело отпускать прошлое

обида, которая хранится слишком долго

💎 4. Скрытые таланты
1) Психологический талант

Ты считываешь мотивы людей моментально.
Ты чувствуешь, когда человек врёт или скрывает.

Это мощная энергия психотерапевта, консультанта, наставника.

2) Способность управлять энергиями

Ты умеешь менять атмосферу вокруг себя: своим состоянием, голосом, внутренней силой.

3) Творческое видение

Умение видеть красивое, необычное, метафорическое.

4) Стратегический ум

Луна в Скорпионе даёт талант к стратегии, планированию, точному расчёту.

⚖️ 5. Кармические уроки
Урок №1 — доверие

Переход от недоверия, контроля и возможной внутренней закрытости — к умению открываться, не оберегая себя от всего подряд.

Урок №2 — отпускание прошлого

Не тащить старую боль или вину за собой.
Скорпион учит «умирать и возрождаться».

Урок №3 — принятие своей силы

Ты часто недооцениваешь свои способности — карма требует научиться стоять в силе спокойно, без необходимости доказывать.

Урок №4 — баланс реальности и духовности

Рыбья энергия может «уплывать» — важно держать связь с землёй.

❤️ 6. Отношения

Ты в отношениях очень преданный, глубокий, честный.

Но:

тебе нужна реальная близость, а не поверхностные связи

ты терпеть не можешь ложь

для тебя любовь — это трансформация

ты чувствуешь партнёра глубже, чем он сам себя

Ты выбираешь сильных, умных и честных людей.
Если человек слаб духом — тебе с ним быстро становится скучно.

Какая пара идеальна:

тот, кто не боится глубины

кто умеет говорить честно

кто ценит твою интуицию

кто сам развивается и растёт

💰 7. Деньги и финансы

В карте много признаков финансовой интуиции и способности управлять ресурсами.

У тебя талант:

стратегического накопления

правильного выбора момента

понимания рисков

действия через инсайты

Деньги приходят, когда ты занимаешься чем-то, что имеет смысл, глубину, людям приносит пользу.

🛠 8. Карьера и предназначение

Лучшее направление — там, где объединяются:
...
Тебе подходят профессии:

психолог, коуч, наставник
...
эзотерика, медиация, духовные практики

Ты можешь вести людей за собой мягко, но твёрдо.
Ты хороший управленец, но не выдерживаешь тупой бюрократии — нужна свобода.
...
лишние переживания → телесные блоки

Твоё здоровье сильно зависит от:
...
🔮 10. Итоговое предназначение
Ты здесь, чтобы стать человеком глубины, силы и внутреннего света, который помогает другим трансформироваться своим примером.

Ты соединяешь в себе две энергии:

Рыбью тонкость и мудрость

Скорпионью силу и способность к обновлению

Когда ты следуешь своему внутреннему компасу — ты становишься невероятно сильным и влияющим человеком.
        {prompt_end}
        """
